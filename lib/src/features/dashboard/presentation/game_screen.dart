...
class _GameScreenState extends State<GameScreen> {
  ...
  final ValueNotifier<Rating> _rating =
      ValueNotifier(const Rating(total: 0, average: 0));
                ...
                SizedBox(
                  ...
                  child: Stack(
                    children: [
                      Container(
                        color:
                            context.colorScheme.inverseSurface.withOpacity(0.3),
                        width: double.infinity,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${widget.game.publisher}  |  ${widget.game.releaseDate.year}',
                      ...
                      ReviewsWidget(
                        ...
                        onReviewAdded: (rev) {
                          ...
                          final totalRating = rat.average * rat.total;
                          final newRating = (totalRating + rev.review.rating) /
                              (rat.total + 1);
